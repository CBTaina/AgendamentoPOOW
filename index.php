...
include './backend/listar_sala.php';
/* Iniciando sessão */
session_start();
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <button type="button" id="sidebarCollapse" class="btn btn-primary"><i class="fas fa-bars"></i> Menu
                </button>
            </div>
        </nav>
            ...
            <div class="modal-body">
                ...
                <div id="content">
                    <div class="container">
                        ...
                        <form id="addevent" enctype="multipart/form-data" action="backend/criar_evento.php" method="post" class="container">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Sala: </label>
                                <div class="col-sm-10">
                                    <select name="sala_id" class="form-control" id="sala_id">
                                        <option value="" disabled selected hidden>Selecione uma sala...</option>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10">
                                    <button type="submit" name="AddEvent" id="AddEvent" value="AddEvent"
                                            class="btn btn-success">Solicitar
                                    </button>
                                </div>
                            </div>
                        </form>
