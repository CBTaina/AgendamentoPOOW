...
<div class="wrapper">
    ...
    <div id="content">
        <div class="container">
            ...
            <form action="backend/criar_sala.php" method="post" class="container">
                ...
                <label for="recursos_disponiveis">Recursos Disponíveis:</label><br>
                <textarea id="recursos_disponiveis" name="recursos_disponiveis" rows="4" cols="50"></textarea><br>
                ...
                <input type="submit" value="Cadastrar Sala" class="btn btn-primary mt-3">
            </form>
        </div>
